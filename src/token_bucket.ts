...
export class TokenBucketEngine {
  ...
  constructor(private readonly config: TokenBucketConfig = { timeoutMs: 5000, maxRetries: 3, enabled: true }) {}
  ...
  public async process(ctx: TokenBucketContext): Promise<{ digest: string; durationMs: number }> {
