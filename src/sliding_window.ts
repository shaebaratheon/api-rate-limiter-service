...
export class SlidingWindowEngine {
  ...
  constructor(private readonly config: SlidingWindowConfig = { timeoutMs: 5000, maxRetries: 3, enabled: true }) {}
  ...
  public async process(ctx: SlidingWindowContext): Promise<{ digest: string; durationMs: number }> {
