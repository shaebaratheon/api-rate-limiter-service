...
export interface MetricsExporterContext {
...
export class MetricsExporterEngine {
  ...
  constructor(private readonly config: MetricsExporterConfig = { timeoutMs: 5000, maxRetries: 3, enabled: true }) {}
  ...
  public async process(ctx: MetricsExporterContext): Promise<{ digest: string; durationMs: number }> {
